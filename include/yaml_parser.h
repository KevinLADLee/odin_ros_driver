...
private:
    ...
    std::unordered_set<std::string> allowed_key_w_str_val = {"relocalization_map_abs_path", "mapping_result_dest_dir", "mapping_result_file_name", "topic_prefix", "imu_frame_id", "base_frame_id", "odom_frame_id", "map_frame_id"};
};
